...
var $author$project$Main$init = function (flags) {
	...
	return _Utils_Tuple2(
		{changesetDetail: $elm$core$Maybe$Nothing, channelFilter: '', channelSort: $author$project$Main$ChannelSortAlpha, channelTooltipName: '', channels: _List_Nil, commitMessage: '', committedSectionOpen: false, connected: false, editContent: '', editIsNew: false, editJsonError: $elm$core$Maybe$Nothing, editResourceId: '', expandedPatches: _List_Nil, flashIsError: false, flashMessage: $elm$core$Maybe$Nothing, historyEntries: _List_Nil, historyResourceId: '', importChannelLog: _List_Nil, importChannelResources: _List_Nil, importSourceChannel: '', logEntries: _List_Nil, newChannelName: '', nextNotifId: 0, notifications: _List_Nil, notificationsVisible: true, page: $author$project$Main$SetupPage, promoteChannel: '', remoteChannels: _List_Nil, resourceFilter: '', resourceSort: $author$project$Main$SortByIdAsc, resources: _List_Nil, restoreChangeId: '', restoreChannel: '', restoreMode: 'channel', restoreResourceId: '', serverUrl: serverUrl, showAllChannels: false, showCommitDialog: false, showNewChannelDialog: false, showPromoteDialog: false, showRestoreDialog: false, snapshots: _List_Nil, stagedSectionOpen: true, status: $author$project$Main$emptyStatus, tooltipContent: '', tooltipResourceId: '', userId: '', workingSectionOpen: true},
...
var $author$project$Main$GotDeleteChannelResult = function (a) {
	return {$: 'GotDeleteChannelResult', a: a};
};
...
var $author$project$Main$GotStageAllResult = function (a) {
	return {$: 'GotStageAllResult', a: a};
};
...
var $author$project$Main$GotSyncMainResult = function (a) {
	return {$: 'GotSyncMainResult', a: a};
};
var $author$project$Main$GotUnstageResult = function (a) {
	return {$: 'GotUnstageResult', a: a};
};
...
var $author$project$Ports$onDeleteChannelResult = _Platform_incomingPort('onDeleteChannelResult', $elm$json$Json$Decode$value);
...
var $author$project$Ports$onStageAllResult = _Platform_incomingPort('onStageAllResult', $elm$json$Json$Decode$value);
...
var $author$project$Ports$onSyncMainResult = _Platform_incomingPort('onSyncMainResult', $elm$json$Json$Decode$value);
var $author$project$Ports$onUnstageResult = _Platform_incomingPort('onUnstageResult', $elm$json$Json$Decode$value);
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Ports$onStageAllResult($author$project$Main$GotStageAllResult),
				$author$project$Ports$onSyncMainResult($author$project$Main$GotSyncMainResult),
				$author$project$Ports$onUnstageResult($author$project$Main$GotUnstageResult),
				$author$project$Ports$onDeleteChannelResult($author$project$Main$GotDeleteChannelResult)
			]));
};
...
var $author$project$Main$PatchInfo = F4(
	function (targetResource, opsCount, hasSnapshot, operations) {
		return {hasSnapshot: hasSnapshot, operations: operations, opsCount: opsCount, targetResource: targetResource};
	});
var $author$project$Main$PatchOp = F4(
	function (op, path, value, from) {
		return {from: from, op: op, path: path, value: value};
	});
...
var $author$project$Main$decodePatchOp = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$PatchOp,
		...
		$elm$json$Json$Decode$list(
			A5(
				...
				A2(
					$elm$json$Json$Decode$field,
					'operations',
					$elm$json$Json$Decode$list($author$project$Main$decodePatchOp))))));
...
var $author$project$Ports$deleteChannel = _Platform_outgoingPort(
	'deleteChannel',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'force',
					$elm$json$Json$Encode$bool($.force)),
					_Utils_Tuple2(
					'name',
...
var $author$project$Main$filePathToResourceId = function (path) {
	return A3(
		$elm$core$String$replace,
		'/',
		'.',
		function (p) {
			return A2($elm$core$String$endsWith, '.json', p) ? A2($elm$core$String$dropRight, 5, p) : p;
		}(path));
};
...
var $author$project$Ports$stageAll = _Platform_outgoingPort(
	'stageAll',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Ports$switchChannel = _Platform_outgoingPort('switchChannel', $elm$json$Json$Encode$string);
var $author$project$Ports$syncMain = _Platform_outgoingPort(
	'syncMain',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
...
var $author$project$Ports$unstageAll = _Platform_outgoingPort(
	'unstageAll',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Ports$unstageResource = _Platform_outgoingPort('unstageResource', $elm$json$Json$Encode$string);
		...
		switch (msg.$) {
						...
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									$author$project$Ports$syncMain(_Utils_Tuple0)
								])));
				} else {
					var detail = A2(
						$elm$core$Result$withDefault,
				...
				if (_v4.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								resources: A2($elm$core$List$map, $author$project$Main$filePathToResourceId, files)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
			...
			case 'ViewChangeset':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{changesetDetail: $elm$core$Maybe$Nothing, expandedPatches: _List_Nil, page: $author$project$Main$ChangesetDetailPage}),
			...
			case 'GotNotification':
				...
				if (_v27.$ === 'Ok') {
					...
					var syncCmd = (newNotif.channel === 'main') ? $author$project$Ports$syncMain(_Utils_Tuple0) : $elm$core$Platform$Cmd$none;
					var localNames = A2(
						$elm$core$List$map,
						function ($) {
							return $.name;
			...
			case 'ToggleShowAllChannels':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'StageAllWorking':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							flashIsError: false,
							flashMessage: $elm$core$Maybe$Just('Staging all working files...')
						}),
					$author$project$Ports$stageAll(_Utils_Tuple0));
			case 'GotStageAllResult':
				var val = msg.a;
				var _v31 = A2(
					$elm$json$Json$Decode$decodeValue,
					A2($elm$json$Json$Decode$field, 'success', $elm$json$Json$Decode$bool),
				...
				if ((_v31.$ === 'Ok') && _v31.a) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								flashIsError: false,
								flashMessage: $elm$core$Maybe$Just(
									'Staged ' + ($elm$core$String$fromInt(count) + ' file(s)'))
							}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
			...
			case 'UnstageResource':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							flashIsError: false,
							flashMessage: $elm$core$Maybe$Just('Unstaging \'' + (resourceId + '\'...'))
						}),
					$author$project$Ports$unstageResource(resourceId));
			case 'UnstageAllStaged':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							flashIsError: false,
							flashMessage: $elm$core$Maybe$Just('Unstaging all staged changes...')
						}),
					$author$project$Ports$unstageAll(_Utils_Tuple0));
			case 'GotUnstageResult':
				var val = msg.a;
				var _v32 = A2(
					$elm$json$Json$Decode$decodeValue,
					A2($elm$json$Json$Decode$field, 'success', $elm$json$Json$Decode$bool),
			...
			case 'GotSyncMainResult':
				...
				var _v33 = A2(
					...
					val);
				if ((_v33.$ === 'Ok') && _v33.a) {
					var currentChannel = model.status.channel;
					var refreshCmd = (currentChannel === 'main') ? $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Ports$requestStatus(_Utils_Tuple0),
								$author$project$Ports$listSnapshots(_Utils_Tuple0),
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								flashIsError: false,
								flashMessage: $elm$core$Maybe$Just('Main channel synced from remote')
							}),
						refreshCmd);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'TogglePatchOps':
				var targetResource = msg.a;
				var newExpanded = A2($elm$core$List$member, targetResource, model.expandedPatches) ? A2(
					$elm$core$List$filter,
					function (r) {
						return !_Utils_eq(r, targetResource);
					},
					model.expandedPatches) : A2($elm$core$List$cons, targetResource, model.expandedPatches);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{expandedPatches: newExpanded}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleStagedSection':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{stagedSectionOpen: !model.stagedSectionOpen}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleWorkingSection':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{workingSectionOpen: !model.workingSectionOpen}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleCommittedSection':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{committedSectionOpen: !model.committedSectionOpen}),
					$elm$core$Platform$Cmd$none);
			case 'RequestDeleteChannel':
				...
				return _Utils_Tuple2(
					model,
					$author$project$Ports$deleteChannel(
						{force: force, name: name}));
			case 'GotDeleteChannelResult':
				var val = msg.a;
				var _v34 = A2(
					$elm$json$Json$Decode$decodeValue,
					A2($elm$json$Json$Decode$field, 'success', $elm$json$Json$Decode$bool),
				...
				if ((_v34.$ === 'Ok') && _v34.a) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								flashIsError: false,
								flashMessage: $elm$core$Maybe$Just('Deleted channel \'' + (chName + '\''))
							}),
						$author$project$Ports$requestChannels(_Utils_Tuple0));
				} else {
					var detail = A2(
...
var $author$project$Main$TogglePatchOps = function (a) {
	return {$: 'TogglePatchOps', a: a};
};
...
var $author$project$Main$viewPatchOp = F2(
	function (idx, op) {
		var valueDisplay = function () {
			var _v2 = op.value;
			if (_v2.$ === 'Just') {
				var v = _v2.a;
				return A2($author$project$Main$truncateContent, v, 200);
			} else {
				return '';
			}
		}();
		var opColor = function () {
			var _v1 = op.op;
			switch (_v1) {
				case 'add':
					return '#34d399';
		...
		return A2(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'color', opColor),
									A2($elm$html$Html$Attributes$style, 'text-transform', 'uppercase'),
									A2($elm$html$Html$Attributes$style, 'min-width', '60px')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(op.op)
								])),
							A2(
							$elm$html$Html$span,
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'color', '#c4c9d4')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(op.path)
								])),
							(fromDisplay !== '') ? A2(
							$elm$html$Html$span,
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'color', '#8b8fa3')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(fromDisplay)
								])) : $elm$html$Html$text('')
						])),
					(valueDisplay !== '') ? A2(
					$elm$html$Html$pre,
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$style, 'margin', '4px 0 0 68px'),
							A2($elm$html$Html$Attributes$style, 'padding', '6px 8px'),
							A2($elm$html$Html$Attributes$style, 'background', 'rgba(0,0,0,0.2)'),
							A2($elm$html$Html$Attributes$style, 'border-radius', '3px'),
							A2($elm$html$Html$Attributes$style, 'font-size', '11px'),
							A2($elm$html$Html$Attributes$style, 'color', '#a0a4b0'),
					...
					_List_fromArray(
						[
							$elm$html$Html$text(valueDisplay)
						])) : $elm$html$Html$text('')
				]));
	});
var $author$project$Main$viewPatchItem = F3(
	function (changeId, expandedPatches, patch) {
		var isExpanded = A2($elm$core$List$member, patch.targetResource, expandedPatches);
		...
		return A2(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Main$TogglePatchOps(patch.targetResource))
								]),
							_List_fromArray(
								[
									A2(
					...
					A2($elm$core$List$indexedMap, $author$project$Main$viewPatchOp, patch.operations)) : $elm$html$Html$text('')
				]));
	});
									...
									return A2(
										...
										_List_fromArray(
											[
												...
												A2(
													$elm$core$List$map,
													A2($author$project$Main$viewPatchItem, detail.changeId, model.expandedPatches),
													detail.patches))
											]));
								}
							}()
...
var $author$project$Main$StageAllWorking = {$: 'StageAllWorking'};
var $author$project$Main$ToggleCommittedSection = {$: 'ToggleCommittedSection'};
var $author$project$Main$ToggleStagedSection = {$: 'ToggleStagedSection'};
var $author$project$Main$ToggleWorkingSection = {$: 'ToggleWorkingSection'};
var $author$project$Main$UnstageAllStaged = {$: 'UnstageAllStaged'};
...
var $author$project$Main$UnstageResource = function (a) {
	return {$: 'UnstageResource', a: a};
};
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('btn btn-sm btn-ghost'),
									A2($elm$html$Html$Attributes$style, 'color', '#f87171'),
									$elm$html$Html$Events$onClick(
									$author$project$Main$UnstageResource(resourceId))
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Unstage')
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('panel-header'),
								A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
								$elm$html$Html$Events$onClick($author$project$Main$ToggleStagedSection)
							]),
						_List_fromArray(
							[
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Events$onClick($author$project$Main$UnstageAllStaged)
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Unstage All')
											]))
									]))
							])),
						model.stagedSectionOpen ? A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('panel-body')
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('panel-header'),
								A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
								$elm$html$Html$Events$onClick($author$project$Main$ToggleWorkingSection)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('btn btn-sm btn-primary'),
												$elm$html$Html$Events$onClick($author$project$Main$StageAllWorking)
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Stage All')
											]))
									]))
							])),
						model.workingSectionOpen ? A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('panel-body')
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('panel-header'),
								A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
								$elm$html$Html$Events$onClick($author$project$Main$ToggleCommittedSection)
							]),
						_List_fromArray(
							[
								A2(
...
var $author$project$Main$RequestDeleteChannel = F2(
	function (a, b) {
		return {$: 'RequestDeleteChannel', a: a, b: b};
	});
								...
								[
									...
									_List_fromArray(
										[
											...
											A2($elm$html$Html$Attributes$style, 'text-decoration', 'underline'),
											$elm$html$Html$Events$onClick(
											A2($author$project$Main$RequestDeleteChannel, ch.name, false))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Delete')
									...
									_List_fromArray(
										[
											...
											A2($elm$html$Html$Attributes$style, 'text-decoration', 'underline'),
											$elm$html$Html$Events$onClick(
											A2($author$project$Main$RequestDeleteChannel, ch.name, true))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Force Delete')
										]))
								])) : $elm$html$Html$text('')
						])) : $elm$html$Html$text('')
				]));
